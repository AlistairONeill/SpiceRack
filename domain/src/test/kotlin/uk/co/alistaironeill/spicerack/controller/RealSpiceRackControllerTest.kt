...
class RealSpiceRackControllerTest {
    private val spiceRackIO = StubSpiceRackIO()
    private val spiceSource = InMemorySpiceSource()
    private val ledGroupSource = InMemoryLedGroupSource()
    private val slotSource = InMemorySpiceSlotSource()

    private val controller = RealSpiceRackController(
        spiceRackIO,
        spiceSource,
        ledGroupSource,
        slotSource
